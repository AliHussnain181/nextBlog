        ...
        <>
            ...
            <div className='hidden lg:block'>
                <div className={`flex justify-between h-[100vh] w-full z-[9] fixed top-[0] ${menu ? 'translate-y-0' : '-translate-y-[150vh]'}  transition-all duration-500 `}>
                    <div onClick={menuBar} className={`w-[50%] bg-[#0C312A] flex flex-col items-center text-white text-4xl font-Sf space-y-12 py-44  `}>
                        <Link href="/">Home</Link>
                        <Link href="/blogs">Blogs</Link>
                        <Link href="#features">features Blogs</Link>
                        {
                    ...
                    <div className='w-[50%]  bg-cover bg-no-repeat bg-[url(/hero.jpg)]' >
                        <div className='text-white pt-32 font-Sf text-center w-[80%] mx-auto space-y-9'>
                            ...
                            <div className='flex justify-center space-x-4'>
                                <Link className='text-2xl p-3 border-green-500 border-[3px] rounded-full' href="/" target='_blank' ><FiFacebook /></Link>
                                <Link className='text-2xl p-3 border-green-500 border-[3px] rounded-full' href="/" target='_blank' ><FiLinkedin /></Link>
                                <Link className='text-2xl p-3 border-green-500 border-[3px] rounded-full' href="/" target='_blank' ><AiOutlineInstagram /></Link>
                                <Link className='text-2xl p-3 border-green-500 border-[3px] rounded-full' href="/" target='_blank' ><FiGithub /></Link>
                                <Link className='text-2xl p-3 border-green-500 border-[3px] rounded-full' href="/" target='_blank' ><FiTwitter /></Link>
                            </div>
                        </div>
                    </div>
                </div>
