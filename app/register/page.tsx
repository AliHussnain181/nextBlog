            ...
            <form onSubmit={registerHandler} className='w-[90%] mx-auto flex flex-col justify-center items-center'>
                ...
                <button
                    ...
                    className={`w-full sm:w-[80%] md:w-[29rem] py-2 rounded-md text-sm my-4 transition-all ${
                        loading ? "bg-gradient-to-r from-gray-400 to-gray-600 cursor-not-allowed" : "bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%"
                    }`}
                >
